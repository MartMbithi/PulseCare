                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">System Users /</span> Patients
                            <div class="d-flex justify-content-end">
                                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_user" href="javascript:void(0);">Add New Patient</a>
                            </div>
                        </h4>
                        <div class="row">
                            <div class="col-xl-12">
                                            ...
                                            <table class="table data_table">
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    ...
                                                    $user_sql = mysqli_query(
                                                        $mysqli,
                                                        "SELECT * FROM  users WHERE user_access_level = 'Patient'"
                                                    );
                                                    $cnt = 1;
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" readonly value="User@1234" class="form-control" id="address" name="user_password" />
                            <input type="hidden" value="Patient" class="form-control" id="address" name="user_designation" />
                            <input type="hidden" class="form-control" id="address" name="user_access_level" value="Patient" />
                        </div>
                    </div>
                </div>
