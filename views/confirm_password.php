            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4 text-center">Enter your new password and confirm it</p>
                        <form id="formAuthentication" class="mb-3" method="POST">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" name="Reset_Password_Step_2" type="submit">Reset pasword</button>
                            </div>
                        </form>
                    </div>
                </div>
