                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">System Users /</span> Doctors
                            <div class="d-flex justify-content-end">
                                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_user" href="javascript:void(0);">Add New Doctor</a>
                            </div>
                        </h4>
                        <div class="row">
                            <div class="col-xl-12">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="hidden" value="Doctor" class="form-control" id="address" name="user_designation" />
                            <input type="hidden" class="form-control" id="address" name="user_access_level" value="Doctor" />
                        </div>
                    </div>
                </div>
